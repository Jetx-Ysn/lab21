...
#include<string>
#include<cstdlib>
HWND textstart,input1,input2,button1,button2,button3,button4;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
		...
		case WM_CREATE:
		textstart = CreateWindow("STATIC", " Please input two numbers",
		...
		char answer[10];
			...
			{
				case 1:
					GetWindowText(input1, num1, 10);
					GetWindowText(input2, num2, 10);
